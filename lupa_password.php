		...
		<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<p class="lead text-center">Lupa Password</p>
						<div class="space"></div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-6">
								<p>Masukkan Email pada Form Dibawah !</p>
								<p>Sistem kami akan mengirimkan kode yang akan anda gunakan untuk mengubah password anda.</p>
								<form action="#" id="emailkodepass" class="form-horizontal" role="form" method="post">	
					                ...
					                <div style="margin-top:10px" class="form-group">
						                ...
						                <div class="col-sm-12 controls">
						                	<button type="submit" class="btn btn-success" id="btn-login">Kirim Kode</button>
						                </div>
				                	</div>
				                </form>
				                ...
				                <form action="#" id="kodepassform" class="form-horizontal" role="form" method="post">
					                ...
					                <div class="col-sm-8">
				                          <div class='input-group'>
				                              ...
				                              <input type='text' class="form-control" id="kodepass" name="kodepass" placeholder="Masukkan Kode"/>
				                          </div>
				                        </div>
				            		</div>
				            		<div style="margin-top:10px" class="form-group">
				                		<!-- Button -->
						                <div class="col-sm-12 controls">
						                	<button type="submit" class="btn btn-success" id="btn-login">Reset Password</button>
						                </div>
				                	</div>
			            		</form>
