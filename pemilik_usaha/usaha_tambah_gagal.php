	...
	<body class="no-trans" onLoad="load()">
		...
		<div class="section translucent-bg bg-image-3">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<br>
				<h1 id="usahabaru"  class="text-center title">><span>___</span><</h1>
				<div class="space"></div>
				<div class="row">
				  <div class="col-md-12">
				  	  <div class="alert alert-danger" role="alert">
	                    <strong>Terjadi kesalahan dalam proses pendaftaran !! </strong><br>
	                     Hubungi Pihak Dinas. Terima Kasih<br>
