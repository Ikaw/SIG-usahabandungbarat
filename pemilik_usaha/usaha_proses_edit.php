            ...
            if (isset($_POST['id_usaha'])) 
                  {
                    ...
                    $sql = "UPDATE data_usaha
                            SET    nama_usaha='$nama_usaha', produk_utama='$produk_utama',
                                   alamat_usaha='$alamat_usaha', deskripsi_usaha='$deskripsi_usaha',
                                   lat='$lat', lng='$lng', id_kec='$id_kec', id_desa='$id_desa', id_sektor='$id_sektor',
                                   skala='$skala'
