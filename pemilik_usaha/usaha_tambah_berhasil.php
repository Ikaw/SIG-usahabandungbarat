	...
	<body class="no-trans" onLoad="load()">
		...
		<div class="section translucent-bg bg-image-3">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<br>
				<h1 id="usahabaru"  class="text-center title">Daftar Usaha <span>Baru</span></h1>
				<div class="space"></div>
				<div class="row">
				  <div class="col-md-12">
				  	  <div class="alert alert-success" role="alert">
	                    <strong>Usaha Anda sudah Terdaftar !! </strong><br>
	                     Tunggu proses Aktivasi oleh Pihak Dinas. Terima Kasih<br><br>
