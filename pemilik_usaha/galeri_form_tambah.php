	...
	<body class="no-trans" onLoad="load()">
		...
		<div class="section translucent-bg bg-image-3">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<br>
				<h1 id="usahabaru"  class="text-center title">Tambah <span>Gambar</span></h1>
				<div class="space"></div>
				<div class="row">
					<div class="col-md-12">
						<form method="POST" action="galeri_proses_tambah.php" class="form-horizontal" enctype="multipart/form-data">
						    <div class="form-group">
						      <label for="nama_kec" class="col-sm-4 control-label">Nama Usaha</label>
						      <div class="col-sm-8">
						        <select name="id_usaha" color="#000">
						        <?php
						          $link = koneksi_db();
						          $no_ktp = $_SESSION['no_ktp'];
						          $sql="SELECT * FROM data_usaha where dihapus='T' && aktivasi='ACTIVE' && no_ktp='$no_ktp'";
