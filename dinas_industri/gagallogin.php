		...
		<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						<p class="lead text-center">Terjadi Kesalahan Saat Login</p>
						<div class="space"></div>
						<div class="row">
							<div class="col-md-3">
							...
							<div class="col-md-6">
								<p>Mohon Cek Kembali Alamat <strong>Email</strong> dan <strong>Password</strong> Anda.</p>
								<p>Fasilitas Login hanya bisa dilakukan oleh pengusaha yang telah <strong>terdaftar</strong> pada database kami.</p>
								<p>Apabila anda belum mendaftar silahkan klik link dibawah ini !</p>
								<p>Apabila anda telah mendaftar namun tidak bisa Login Kemungkinan kesalahan terjadi karena data anda belum terverifikasi oleh sistem kami. Silahkan Hubungi Kami Pada Link dibawah ini !</p>
