    ...
    <div class="row show-grid">
      ...
      <div class="col-md-9">
        <div class="row show-grid">
          ...
          <form id="pencarian" method="POST" action="kecamatan_view.php">
          <div class="col-md-7">
              ...
              <div class="panel-body">
                ...
                <div class="table-responsive">
                  <?php
                    ...
                    $cari = $_POST['filter'];
                    $where="WHERE id_kec like '%$cari%' OR nama_kec like '%$cari%'";
                    } else {
                    $where=''; }

                    $sql="select * from kecamatan $where order by id_kec";
                      ...
                      <tbody>
                        ...
                        <td>
                              <!--Hapus Data-->
                                ...
                                <a href="javascript:;" data-id="<?php echo $data['id_kec']; ?>" data-toggle="modal" data-target="#modal-konfirmasi">
                              ...
                              <div class="modal fade" id="modal-konfirmasi" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-body" data-id="<?php echo $data['nama_kec']?>">
                                      Apakah anda yakin akan menghapus kecamatan <?php echo $data['nama_kec'];?> ??
                                    </div>
                              ...
                              <!--Ubah Data-->
                              <a href="kecamatan_form_edit.php?id_kec=<?php echo $data['id_kec'];?>"><button type="submit" class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Ubah"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></button></a>
                            </td>
                      </tr>
                      </tbody>
                      <?php
